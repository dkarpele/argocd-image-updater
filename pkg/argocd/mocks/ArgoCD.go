...
import (
	...
	argocd "github.com/argoproj-labs/argocd-image-updater/pkg/argocd"
...
// FilterApplicationsForUpdate provides a mock function with given fields: ctx, cr
func (_m *ArgoCD) FilterApplicationsForUpdate(ctx context.Context, cr *v1alpha1.ImageUpdater) (map[string]argocd.ApplicationImages, error) {
	...
	var r0 map[string]argocd.ApplicationImages
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1alpha1.ImageUpdater) (map[string]argocd.ApplicationImages, error)); ok {
		return rf(ctx, cr)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *v1alpha1.ImageUpdater) map[string]argocd.ApplicationImages); ok {
		r0 = rf(ctx, cr)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]argocd.ApplicationImages)
		}
	}
...
// ListApplications provides a mock function with given fields: ctx, cr
func (_m *ArgoCD) ListApplications(ctx context.Context, cr *v1alpha1.ImageUpdater) ([]applicationv1alpha1.Application, error) {
	ret := _m.Called(ctx, cr)
